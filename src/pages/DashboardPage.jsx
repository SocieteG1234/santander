  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24 flex flex-col">
      ...
      <header className="bg-white border-b border-gray-200 px-4 py-3 sticky top-0 z-50">
        ...
        <div className="max-w-lg mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-[#0B1F3A] hidden sm:block">
              LIDION BANK
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="absolute top-1 right-1 w-4 h-4 bg-[#C9A227] text-white text-xs font-bold rounded-full flex items-center justify-center">
                2
              </span>
            </button>
      ...
      <main className="max-w-lg mx-auto w-full px-4 py-6 space-y-4">
        ...
        {/* Solde */}
        <div className="bg-[#0B1F3A] rounded-2xl p-6 text-white shadow-lg">
          ...
          <p className="text-4xl font-bold">
            {formatMontant(currentUser?.solde)}{" "}
            {currentUser?.devise}
          </p>

          <div className="w-12 h-1 bg-[#C9A227] rounded-full mt-3 mb-2" />
          ...
          <div className="bg-white border-2 border-red-500 rounded-2xl p-5 shadow-sm">
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 text-center">
              ...
              <p className="text-3xl font-bold text-red-600">
                {formatMontant(currentUser?.montantDeblocage)}{" "}
                {currentUser?.devise}
              </p>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => navigate("historique")}
              className="text-[#0B1F3A] text-xs font-semibold hover:text-[#C9A227] transition"
            >
              Voir tout
            </button>
